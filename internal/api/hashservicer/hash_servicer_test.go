...
func TestValidHashServer(t *testing.T) {
	...
	clientMetric.Hash = hashAgent.GenerateHash(models.JSONMetrics{ID: clientMetric.ID, MType: clientMetric.MType, Delta: clientMetric.Delta, Value: clientMetric.Value})
